...
import static no.monopixel.slimcolonies.api.research.util.ResearchConstants.ARMOR_DURABILITY;
import static no.monopixel.slimcolonies.api.research.util.ResearchConstants.TOOL_DURABILITY;
import static no.monopixel.slimcolonies.api.util.constant.CitizenConstants.*;
import static no.monopixel.slimcolonies.api.util.constant.Constants.DEFAULT_PITCH_MULTIPLIER;
import static no.monopixel.slimcolonies.api.util.constant.Constants.DEFAULT_VOLUME;
