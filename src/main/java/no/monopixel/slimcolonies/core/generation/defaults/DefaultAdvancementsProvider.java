...
import no.monopixel.slimcolonies.api.advancements.all_towers.AllTowersCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.army_population.ArmyPopulationCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.building_add_recipe.BuildingAddRecipeCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.citizen_bury.CitizenBuryCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.citizen_eat_food.CitizenEatFoodCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.citizen_resurrect.CitizenResurrectCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.click_gui_button.ClickGuiButtonCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.colony_population.ColonyPopulationCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.complete_build_request.CompleteBuildRequestCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.create_build_request.CreateBuildRequestCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.deep_mine.DeepMineCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.max_fields.MaxFieldsCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.place_structure.PlaceStructureCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.place_supply.PlaceSupplyCriterionInstance;
import no.monopixel.slimcolonies.api.advancements.undertaker_totem.UndertakerTotemCriterionInstance;
import no.monopixel.slimcolonies.api.blocks.ModBlocks;
import no.monopixel.slimcolonies.api.colony.buildings.ModBuildings;
import no.monopixel.slimcolonies.api.colony.buildings.registry.BuildingEntry;
import no.monopixel.slimcolonies.api.items.ModItems;
import no.monopixel.slimcolonies.api.util.constant.WindowConstants;
...
public class DefaultAdvancementsProvider extends ForgeAdvancementProvider
{
    public static AdvancementGenerator generator = (registries, consumer, fileHelper) -> {
        ...
        Advancement.Builder.advancement()
            ...
            .display(ModItems.supplyChest,
                Component.translatable("advancements.slimcolonies.root.title"),
                Component.translatable("advancements.slimcolonies.root.description"),
                null,
    ...
    private static void addStandardAdvancements(
        @NotNull final Consumer<Advancement> consumer,
        @NotNull final ExistingFileHelper fileHelper)
    {
        final String GROUP = "slimcolonies/";
        ...
        @NotNull final ExistingFileHelper fileHelper)
    {
        ...
        final Advancement root = Advancement.Builder.advancement()
            .display(ModBlocks.blockHutBuilder,
                Component.translatable("advancements.slimcolonies.root.production.title"),
                Component.translatable("advancements.slimcolonies.root.production.description"),
        ...
        @NotNull final ExistingFileHelper fileHelper)
    {
        ...
        final Advancement root = Advancement.Builder.advancement()
            .display(ModBlocks.blockHutBarracks,
                Component.translatable("advancements.slimcolonies.root.military.title"),
                Component.translatable("advancements.slimcolonies.root.military.description"),
    ...
    private static DisplayInfo make(
        @NotNull final FrameType frame,
        @NotNull final ItemLike icon,
        @NotNull final String name)
    {
        return new DisplayInfo(new ItemStack(icon),
            Component.translatable("advancements.slimcolonies." + name + ".title"),
            Component.translatable("advancements.slimcolonies." + name + ".description"),
