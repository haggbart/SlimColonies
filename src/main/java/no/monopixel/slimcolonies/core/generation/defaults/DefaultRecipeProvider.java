...
//                .save(consumer);
    ...
    private static ResourceLocation append(
        @NotNull final ResourceLocation base,
     ...
     */
    private static void registerHutRecipe1(
     ...
     */
    private static void registerHutRecipe1x2(
        @NotNull final Consumer<FinishedRecipe> consumer,
        @NotNull final ItemLike output,
        @NotNull final ItemLike input,
     ...
     */
    private static void registerHutRecipe3(
        @NotNull final Consumer<FinishedRecipe> consumer,
        @NotNull final ItemLike output,
        @NotNull final ItemLike input)
    {
    ...
    private void buildFood(@NotNull final Consumer<FinishedRecipe> consumer)
    {
        ...
        // No player-craftable food recipes needed
    }
