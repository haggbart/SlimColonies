...
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.HUT_BLOCK_MISSING_COLONY;
import static no.monopixel.slimcolonies.api.util.constant.translation.ToolTranslationConstants.TOOL_PERMISSION_SCEPTER_PERMISSION_DENY;
