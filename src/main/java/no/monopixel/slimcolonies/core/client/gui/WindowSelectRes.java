...
import static no.monopixel.slimcolonies.api.util.constant.WindowConstants.BUTTON_SELECT;
import static no.monopixel.slimcolonies.api.util.constant.WindowConstants.NAME_LABEL;
