...
import no.monopixel.slimcolonies.core.colony.buildings.moduleviews.DOCraftingModuleView;
...
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.DOCRAFTING_BLOCK;
...
public class DOCraftingWindow extends AbstractModuleWindow
{
    ...
    private void addRecipe()
    {
        ...
        final IRecipeStorage storage = RecipeStorage.builder()
                ...
                .withGridSize(3)
                .withRecipeType(no.monopixel.slimcolonies.api.crafting.ModRecipeTypes.MULTI_OUTPUT_ID)
                .build();
