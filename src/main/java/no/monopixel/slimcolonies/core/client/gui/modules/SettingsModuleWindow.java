...
import static no.monopixel.slimcolonies.api.util.constant.WindowConstants.DESC_LABEL;
import static no.monopixel.slimcolonies.api.util.constant.WindowConstants.LIST_SETTINGS;
