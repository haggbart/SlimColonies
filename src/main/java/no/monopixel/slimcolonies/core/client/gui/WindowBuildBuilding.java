...
import no.monopixel.slimcolonies.core.network.messages.server.colony.building.BuildingSetStyleMessage;
...
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.ACTION_BUILD;
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.ACTION_UPGRADE;
