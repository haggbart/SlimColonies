...
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.PARTIAL_INFO_TEXT;
import static no.monopixel.slimcolonies.api.util.constant.WindowConstants.BUTTON_EXIT;
