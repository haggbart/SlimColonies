...
import no.monopixel.slimcolonies.core.network.messages.server.colony.building.AddMinimumStockToBuildingModuleMessage;
import no.monopixel.slimcolonies.core.network.messages.server.colony.building.RemoveMinimumStockFromBuildingModuleMessage;
...
public class MinimumStockModuleWindow extends AbstractModuleWindow
{
        ...
        final IMinimumStockModuleView moduleView)
    {
        ...
        if (moduleView.hasReachedLimit())
        {
            ...
            button.setImage(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/gui/builderhut/builder_button_medium_disabled.png"), false);
        }
