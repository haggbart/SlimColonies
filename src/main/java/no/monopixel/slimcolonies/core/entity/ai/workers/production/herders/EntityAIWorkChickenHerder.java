...
public class EntityAIWorkChickenHerder extends AbstractEntityAIHerder<JobChickenHerder, BuildingChickenHerder>
{
    ...
    private final static VisibleCitizenStatus FIND_CHICKEN =
        new VisibleCitizenStatus(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/work/chickenherder.png"), "no.monopixel.slimcolonies.gui.visiblestatus.chickenherder");
