...
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.MESSAGE_INFO_CITIZEN_UNDERTAKER_RESURRECTED_SUCCESS;
import static no.monopixel.slimcolonies.api.util.constant.UndertakerConstants.*;
/**
 * Undertaker AI class.
 */
