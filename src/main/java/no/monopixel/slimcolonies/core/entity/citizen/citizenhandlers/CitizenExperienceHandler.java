...
import no.monopixel.slimcolonies.api.entity.citizen.citizenhandlers.ICitizenExperienceHandler;
...
import static no.monopixel.slimcolonies.api.research.util.ResearchConstants.LEVELING;
import static no.monopixel.slimcolonies.api.util.constant.Constants.XP_PARTICLE_EXPLOSION_SIZE;
