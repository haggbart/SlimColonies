...
import static no.monopixel.slimcolonies.api.util.constant.PathingConstants.SHIFT_X_BY;
import static no.monopixel.slimcolonies.api.util.constant.PathingConstants.SHIFT_Y_BY;
