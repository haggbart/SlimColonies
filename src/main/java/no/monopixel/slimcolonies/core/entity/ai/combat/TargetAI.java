...
import static no.monopixel.slimcolonies.api.util.constant.GuardConstants.DEFAULT_VISION;
import static no.monopixel.slimcolonies.api.util.constant.GuardConstants.Y_VISION;
