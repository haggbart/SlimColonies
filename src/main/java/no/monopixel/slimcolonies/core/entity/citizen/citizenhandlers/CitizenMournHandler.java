...
import static no.monopixel.slimcolonies.api.util.constant.NbtTagConstants.TAG_DECEASED;
import static no.monopixel.slimcolonies.api.util.constant.NbtTagConstants.TAG_MOURNING;
