...
import static no.monopixel.slimcolonies.api.research.util.ResearchConstants.BLOCK_BREAK_SPEED;
import static no.monopixel.slimcolonies.core.placementhandlers.DoBlockPlacementHandler.getCorrectDOItem;
