...
import static no.monopixel.slimcolonies.api.research.util.ResearchConstants.TEACHING;
...
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.PUPIL_NO_CARPET;
