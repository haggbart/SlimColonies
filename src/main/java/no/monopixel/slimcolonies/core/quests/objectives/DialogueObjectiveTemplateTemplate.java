...
import static no.monopixel.slimcolonies.api.quests.QuestParseConstant.TARGET_KEY;
import static no.monopixel.slimcolonies.api.quests.QuestParseConstant.UNLOCKS_REWARDS_KEY;
