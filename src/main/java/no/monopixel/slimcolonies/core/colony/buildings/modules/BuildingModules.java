...
import no.monopixel.slimcolonies.core.colony.buildings.moduleviews.*;
...
public class BuildingModules
{
    ...
    public static final BuildingEntry.ModuleProducer<BedHandlingModule, IBuildingModuleView>     BED               =
        new BuildingEntry.ModuleProducer<>("bed", BedHandlingModule::new, null);
    public static final BuildingEntry.ModuleProducer<FurnaceUserModule, IBuildingModuleView>     FURNACE           =
        new BuildingEntry.ModuleProducer<>("furnace", FurnaceUserModule::new, null);
    public static final BuildingEntry.ModuleProducer<IBuildingModule, RequestTaskModuleView>     CRAFT_TASK_VIEW   =
        new BuildingEntry.ModuleProducer<>("craft_task_view", null, () -> CrafterRequestTaskModuleView::new);
    public static final BuildingEntry.ModuleProducer<IBuildingModule, RequestTaskModuleView>     COURIER_TASK_VIEW =
        new BuildingEntry.ModuleProducer<>("courier_task_view", null, () -> CourierRequestTaskModuleView::new);
    ...
    public static final BuildingEntry.ModuleProducer<RestaurantMenuModule, RestaurantMenuModuleView> RESTAURANT_MENU =
        new BuildingEntry.ModuleProducer<>("restaurant_menu", () -> new RestaurantMenuModule(true, building -> 1), () -> RestaurantMenuModuleView::new);
    ...
    public static final BuildingEntry.ModuleProducer<SettingsModule, SettingsModuleView>             COWHERDER_SETTINGS =
        new BuildingEntry.ModuleProducer<>("cowherder_settings", () -> new SettingsModule().with(AbstractBuilding.BREEDING, new BoolSetting(true))
            ...
            .with(BuildingCowboy.MILK_ITEM, new StringSetting("item.minecraft.milk_bucket")), () -> SettingsModuleView::new);
    ...
    public static final BuildingEntry.ModuleProducer<SettingsModule, SettingsModuleView>             RABBITHERDER_SETTINGS =
        new BuildingEntry.ModuleProducer<>("rabbitherder_settings",
            () -> new SettingsModule().with(AbstractBuilding.BREEDING, new BoolSetting(true)),
            () -> SettingsModuleView::new);
    ...
    public static final BuildingEntry.ModuleProducer<SettingsModule, SettingsModuleView>             SWINEHERDER_SETTINGS =
        new BuildingEntry.ModuleProducer<>("swineherder_settings",
            () -> new SettingsModule().with(AbstractBuilding.BREEDING, new BoolSetting(true)),
            () -> SettingsModuleView::new);
    ...
    public static final BuildingEntry.ModuleProducer<SettingsModule, SettingsModuleView> GUARD_SETTINGS =
        new BuildingEntry.ModuleProducer<>("guard_settings", () -> new SettingsModule()
    ...
    public static final BuildingEntry.ModuleProducer<SettingsModule, SettingsModuleView> GATE_GUARD_SETTINGS =
        new BuildingEntry.ModuleProducer<>("gate_guard_settings", () -> new SettingsModule()
    ...
    public static final BuildingEntry.ModuleProducer<ExpeditionLogModule, ExpeditionLogModuleView>            NETHERWORKER_EXPEDITION =
        new BuildingEntry.ModuleProducer<>("netherworker_expedition", () -> new ExpeditionLogModule(), () -> ExpeditionLogModuleView::new);
}
