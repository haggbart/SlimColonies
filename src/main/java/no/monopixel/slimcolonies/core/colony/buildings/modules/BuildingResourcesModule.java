...
import static no.monopixel.slimcolonies.api.util.constant.NbtTagConstants.TAG_CURR_STAGE;
import static no.monopixel.slimcolonies.api.util.constant.NbtTagConstants.TAG_TOTAL_STAGES;
