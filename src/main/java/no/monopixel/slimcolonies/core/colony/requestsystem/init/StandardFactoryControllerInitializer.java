...
import no.monopixel.slimcolonies.api.colony.requestsystem.factory.standard.IntegerFactory;
import no.monopixel.slimcolonies.api.colony.requestsystem.factory.standard.TypeTokenFactory;
import no.monopixel.slimcolonies.api.colony.requestsystem.token.InitializedTokenFactory;
import no.monopixel.slimcolonies.api.colony.requestsystem.token.RandomSeededTokenFactory;
import no.monopixel.slimcolonies.api.colony.requestsystem.token.StandardTokenFactory;
import no.monopixel.slimcolonies.core.colony.buildings.modules.settings.SettingsFactories;
