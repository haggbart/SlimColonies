...
import no.monopixel.slimcolonies.core.entity.ai.workers.guard.EntityAIKnight;
...
import static no.monopixel.slimcolonies.api.util.constant.GuardConstants.KNIGHT_HP_BONUS;
