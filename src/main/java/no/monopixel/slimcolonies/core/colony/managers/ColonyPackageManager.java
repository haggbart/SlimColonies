...
import no.monopixel.slimcolonies.api.colony.managers.interfaces.IColonyPackageManager;
...
import static no.monopixel.slimcolonies.api.util.constant.ColonyConstants.UPDATE_STATE_INTERVAL;
import static no.monopixel.slimcolonies.api.util.constant.Constants.TICKS_HOUR;
