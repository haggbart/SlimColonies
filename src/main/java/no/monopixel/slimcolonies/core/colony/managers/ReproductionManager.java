...
import no.monopixel.slimcolonies.api.colony.managers.interfaces.IReproductionManager;
...
import static no.monopixel.slimcolonies.api.util.constant.StatisticsConstants.BIRTH;
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.MESSAGE_NEW_CHILD_BORN;
import static no.monopixel.slimcolonies.core.colony.CitizenData.SUFFIXES;
