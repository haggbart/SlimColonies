...
import no.monopixel.slimcolonies.core.entity.ai.workers.service.EntityAIWorkEnchanter;
import net.minecraft.nbt.CompoundTag;
import net.minecraft.core.BlockPos;
import net.minecraft.sounds.SoundEvents;
import org.jetbrains.annotations.NotNull;

import static no.monopixel.slimcolonies.api.util.constant.NbtTagConstants.TAG_BUILDING_TO_DRAIN;
import static no.monopixel.slimcolonies.api.util.constant.NbtTagConstants.TAG_WAITING_TICKS;
