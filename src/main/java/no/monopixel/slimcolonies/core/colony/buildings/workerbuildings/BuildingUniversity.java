...
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.MESSAGE_RESEARCHERS_MORE_KNOWLEDGE;
import static no.monopixel.slimcolonies.api.util.constant.TranslationConstants.RESEARCH_CONCLUDED;
import static no.monopixel.slimcolonies.api.util.constant.StatisticsConstants.RESEARCH_COMPLETED;
