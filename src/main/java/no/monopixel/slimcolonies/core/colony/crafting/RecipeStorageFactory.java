...
import no.monopixel.slimcolonies.api.crafting.IRecipeStorageFactory;
...
import static no.monopixel.slimcolonies.api.colony.requestsystem.StandardFactoryController.NBT_TYPE;
import static no.monopixel.slimcolonies.api.colony.requestsystem.StandardFactoryController.NEW_NBT_TYPE;
import static no.monopixel.slimcolonies.api.util.constant.NbtTagConstants.TAG_TOKEN;
