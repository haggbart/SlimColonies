...
import no.monopixel.slimcolonies.core.colony.interactionhandling.*;
...
public final class ModInteractionsInitializer
{
    ...
    static
    {
        ...
        ModInteractionResponseHandlers.simpleNotification =
            DEFERRED_REGISTER.register(ModInteractionResponseHandlers.SIMPLE_NOTIFICATION.getPath(), () -> new InteractionResponseHandlerEntry.Builder()
                .setResponseHandlerProducer(StandardInteraction::new)
        ...
        ModInteractionResponseHandlers.recruitment =
            DEFERRED_REGISTER.register(ModInteractionResponseHandlers.RECRUITMENT.getPath(), () -> new InteractionResponseHandlerEntry.Builder()
        ...
        ModInteractionResponseHandlers.questAction =
            DEFERRED_REGISTER.register(ModInteractionResponseHandlers.QUEST_ACTION.getPath(), () -> new InteractionResponseHandlerEntry.Builder()
