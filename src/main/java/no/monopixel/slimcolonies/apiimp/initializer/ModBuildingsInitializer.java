...
import no.monopixel.slimcolonies.core.colony.buildings.modules.HomeBuildingModule;
import no.monopixel.slimcolonies.core.colony.buildings.modules.TavernBuildingModule;
import no.monopixel.slimcolonies.core.colony.buildings.views.EmptyView;
...
{
    public final static DeferredRegister<BuildingEntry> DEFERRED_REGISTER = DeferredRegister.create(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "buildings"), Constants.MOD_ID);
    ...
    static
    {
        ModBuildings.archery = DEFERRED_REGISTER.register(ModBuildings.ARCHERY_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ARCHERY_ID))
        ...
        ModBuildings.bakery = DEFERRED_REGISTER.register(ModBuildings.BAKERY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BAKERY_ID))
        ...
        ModBuildings.barracks = DEFERRED_REGISTER.register(ModBuildings.BARRACKS_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BARRACKS_ID))
            .addBuildingModuleProducer(MIN_STOCK)
        ...
        ModBuildings.barracksTower = DEFERRED_REGISTER.register(ModBuildings.BARRACKS_TOWER_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BARRACKS_TOWER_ID))
        ...
        ModBuildings.blacksmith = DEFERRED_REGISTER.register(ModBuildings.BLACKSMITH_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BLACKSMITH_ID))
        ...
        ModBuildings.builder = DEFERRED_REGISTER.register(ModBuildings.BUILDER_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BUILDER_ID))
        ...
        ModBuildings.chickenHerder = DEFERRED_REGISTER.register(ModBuildings.CHICKENHERDER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.CHICKENHERDER_ID))
        ...
        ModBuildings.combatAcademy = DEFERRED_REGISTER.register(ModBuildings.COMBAT_ACADEMY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMBAT_ACADEMY_ID))
        ...
        ModBuildings.composter = DEFERRED_REGISTER.register(ModBuildings.COMPOSTER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMPOSTER_ID))
        ...
        ModBuildings.cook = DEFERRED_REGISTER.register(ModBuildings.COOK_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID))
        ...
        ModBuildings.cowboy = DEFERRED_REGISTER.register(ModBuildings.COWBOY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COWBOY_ID))
        ...
        ModBuildings.crusher = DEFERRED_REGISTER.register(ModBuildings.CRUSHER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.CRUSHER_ID))
        ...
        ModBuildings.deliveryman = DEFERRED_REGISTER.register(ModBuildings.DELIVERYMAN_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.DELIVERYMAN_ID))
        ...
        ModBuildings.farmer = DEFERRED_REGISTER.register(ModBuildings.FARMER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FARMER_ID))
        ...
        ModBuildings.fisherman = DEFERRED_REGISTER.register(ModBuildings.FISHERMAN_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FISHERMAN_ID))
        ...
        ModBuildings.guardTower = DEFERRED_REGISTER.register(ModBuildings.GUARD_TOWER_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID))
        ...
        ModBuildings.home = DEFERRED_REGISTER.register(ModBuildings.HOME_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.HOME_ID))
        ...
        ModBuildings.library = DEFERRED_REGISTER.register(ModBuildings.LIBRARY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID))
        ...
        ModBuildings.lumberjack = DEFERRED_REGISTER.register(ModBuildings.LUMBERJACK_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LUMBERJACK_ID))
        ...
        ModBuildings.miner = DEFERRED_REGISTER.register(ModBuildings.MINER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MINER_ID))
        ...
        ModBuildings.sawmill = DEFERRED_REGISTER.register(ModBuildings.SAWMILL_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SAWMILL_ID))
        ...
        ModBuildings.shepherd = DEFERRED_REGISTER.register(ModBuildings.SHEPHERD_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SHEPHERD_ID))
        ...
        ModBuildings.sifter = DEFERRED_REGISTER.register(ModBuildings.SIFTER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SIFTER_ID))
        ...
        ModBuildings.smeltery = DEFERRED_REGISTER.register(ModBuildings.SMELTERY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SMELTERY_ID))
        ...
        ModBuildings.stoneMason = DEFERRED_REGISTER.register(ModBuildings.STONE_MASON_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STONE_MASON_ID))
        ...
        ModBuildings.stoneSmelter = DEFERRED_REGISTER.register(ModBuildings.STONE_SMELTERY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STONE_SMELTERY_ID))
        ...
        ModBuildings.swineHerder = DEFERRED_REGISTER.register(ModBuildings.SWINE_HERDER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SWINE_HERDER_ID))
        ...
        ModBuildings.townHall = DEFERRED_REGISTER.register(ModBuildings.TOWNHALL_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID))
        ...
        ModBuildings.wareHouse = DEFERRED_REGISTER.register(ModBuildings.WAREHOUSE_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.WAREHOUSE_ID))
        ...
        ModBuildings.postBox = DEFERRED_REGISTER.register(ModBuildings.POSTBOX_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.POSTBOX_ID))
            .createBuildingEntry());
        ...
        ModBuildings.florist = DEFERRED_REGISTER.register(ModBuildings.FLORIST_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FLORIST_ID))
        ...
        ModBuildings.enchanter = DEFERRED_REGISTER.register(ModBuildings.ENCHANTER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ENCHANTER_ID))
        ...
        ModBuildings.university = DEFERRED_REGISTER.register(ModBuildings.UNIVERSITY_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.UNIVERSITY_ID))
        ...
        ModBuildings.hospital = DEFERRED_REGISTER.register(ModBuildings.HOSPITAL_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.HOSPITAL_ID))
        ...
        ModBuildings.stash = DEFERRED_REGISTER.register(ModBuildings.STASH_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STASH_ID))
            .createBuildingEntry());
        ...
        ModBuildings.school = DEFERRED_REGISTER.register(ModBuildings.SCHOOL_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SCHOOL_ID))
        ...
        ModBuildings.glassblower = DEFERRED_REGISTER.register(ModBuildings.GLASSBLOWER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GLASSBLOWER_ID))
        ...
        ModBuildings.dyer = DEFERRED_REGISTER.register(ModBuildings.DYER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.DYER_ID))
        ...
        ModBuildings.fletcher = DEFERRED_REGISTER.register(ModBuildings.FLETCHER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FLETCHER_ID))
        ...
        ModBuildings.tavern = DEFERRED_REGISTER.register(ModBuildings.TAVERN_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TAVERN_ID))
        ...
        ModBuildings.mechanic = DEFERRED_REGISTER.register(ModBuildings.MECHANIC_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MECHANIC_ID))
        ...
        ModBuildings.plantation = DEFERRED_REGISTER.register(ModBuildings.PLANTATION_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.PLANTATION_ID))
        ...
        ModBuildings.rabbitHutch = DEFERRED_REGISTER.register(ModBuildings.RABBIT_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.RABBIT_ID))
        ...
        ModBuildings.concreteMixer = DEFERRED_REGISTER.register(ModBuildings.CONCRETE_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.CONCRETE_ID))
        ...
        ModBuildings.beekeeper = DEFERRED_REGISTER.register(ModBuildings.BEEKEEPER_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BEEKEEPER_ID))
        ...
        ModBuildings.mysticalSite = DEFERRED_REGISTER.register(ModBuildings.MYSTICAL_SITE_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MYSTICAL_SITE_ID))
            .createBuildingEntry());
        ...
        ModBuildings.graveyard = DEFERRED_REGISTER.register(ModBuildings.GRAVEYARD_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GRAVEYARD_ID))
        ...
        ModBuildings.netherWorker = DEFERRED_REGISTER.register(ModBuildings.NETHERWORKER_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.NETHERWORKER_ID))
        ...
        ModBuildings.simpleQuarry = DEFERRED_REGISTER.register(ModBuildings.SIMPLE_QUARRY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingProducer((colony, blockPos) -> new DefaultBuildingInstance(colony, blockPos, ModBuildings.SIMPLE_QUARRY_ID, 1))
            .setBuildingViewProducer(() -> EmptyView::new)
            .addBuildingModuleProducer(SIMPLE_QUARRY)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SIMPLE_QUARRY_ID))
            .createBuildingEntry());
        ...
        ModBuildings.mediumQuarry = DEFERRED_REGISTER.register(ModBuildings.MEDIUM_QUARRY_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingProducer((colony, blockPos) -> new DefaultBuildingInstance(colony, blockPos, ModBuildings.MEDIUM_QUARRY_ID, 1))
            .setBuildingViewProducer(() -> EmptyView::new)
            .addBuildingModuleProducer(MEDIUM_QUARRY)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MEDIUM_QUARRY_ID))
            .createBuildingEntry());
        ...
        /*ModBuildings.largeQuarry = DEFERRED_REGISTER.register( , () -> new BuildingEntry.Builder()
                                   ...
                                   .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LARGE_QUARRY_ID))
                                   .createBuildingEntry());*/
        ...
        ModBuildings.alchemist = DEFERRED_REGISTER.register(ModBuildings.ALCHEMIST_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ALCHEMIST_ID))
        ...
        ModBuildings.kitchen = DEFERRED_REGISTER.register(ModBuildings.KITCHEN_ID, () -> new BuildingEntry.Builder()
            ...
            .setBuildingViewProducer(() -> EmptyView::new)
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.KITCHEN_ID))
            .addBuildingModuleProducer(MIN_STOCK)
            .addBuildingModuleProducer(CRAFT_TASK_VIEW)
        ...
        ModBuildings.gateHouse = DEFERRED_REGISTER.register(ModBuildings.GATE_HOUSE_ID, () -> new BuildingEntry.Builder()
            ...
            .setRegistryName(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GATE_HOUSE_ID))
