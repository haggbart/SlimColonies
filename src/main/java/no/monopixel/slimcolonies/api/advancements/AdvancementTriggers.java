...
import no.monopixel.slimcolonies.api.advancements.citizen_bury.CitizenBuryTrigger;
import no.monopixel.slimcolonies.api.advancements.citizen_eat_food.CitizenEatFoodTrigger;
import no.monopixel.slimcolonies.api.advancements.citizen_resurrect.CitizenResurrectTrigger;
import no.monopixel.slimcolonies.api.advancements.click_gui_button.ClickGuiButtonTrigger;
import no.monopixel.slimcolonies.api.advancements.colony_population.ColonyPopulationTrigger;
import no.monopixel.slimcolonies.api.advancements.complete_build_request.CompleteBuildRequestTrigger;
import no.monopixel.slimcolonies.api.advancements.create_build_request.CreateBuildRequestTrigger;
import no.monopixel.slimcolonies.api.advancements.deep_mine.DeepMineTrigger;
import no.monopixel.slimcolonies.api.advancements.max_fields.MaxFieldsTrigger;
import no.monopixel.slimcolonies.api.advancements.open_gui_window.OpenGuiWindowTrigger;
