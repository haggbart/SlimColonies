package no.monopixel.slimcolonies.api.advancements.citizen_eat_food;
...
public class CitizenEatFoodCriterionInstance extends AbstractCriterionTriggerInstance
{
    ...
    {
        super(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, Constants.CRITERION_CITIZEN_EAT_FOOD), ContextAwarePredicate.ANY);
    }
