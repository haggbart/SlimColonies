package no.monopixel.slimcolonies.api.equipment;
...
import no.monopixel.slimcolonies.api.util.constant.translation.ToolTranslationConstants;
...
public class ModEquipmentTypes
{
    ...
    {
        return ISlimColoniesAPI.getInstance().getEquipmentTypeRegistry();
    }
